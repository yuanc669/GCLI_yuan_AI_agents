...
### 1. Alpha 多樣性：急性豐富度喪失
![Alpha Plots](20260502_Acute_Alpha_Plot.png)

| 指標 | Sham (Mean) | HS2W (Mean) | P-value | 顯著性 |
| :--- | :--- | :--- | :--- | :--- |
| **Chao1 (豐富度)** | 161.98 | 93.40 | 2.4240e-06 | **顯著下降 (***) |
| **Shannon (均勻度)** | 3.5756 | 3.4704 | 0.2585 | n.s. |

- **解讀**: 急性誘導（高糖高脂+STZ）導致腸道菌種豐富度在 2 週內發生**斷崖式下降 (P < 0.0001)**。這代表急性生理壓力對微生態造成的破壞遠超過自然老化。

### 2. Beta 多樣性：群落結構的劇變
![Beta PCoA Plot](20260502_Acute_Beta_PCoA_Plot.png)
- **觀察**: Sham 與 HS2W 在空間座標上完全分離，顯示急性期菌相已發生了質變。
...
![Spearman Heatmap](20260502_Path2_Spearman_Heatmap.png)
...
2. **早期干預窗口**: 
   HS2W 的菌相劇變發生在腎功能顯著惡化之前/同步，暗示透過大蒜外泌體 (GaExo) 在此階段進行干預，可能具備預防病程加速的潛力。
3. **排除噪音**: 
